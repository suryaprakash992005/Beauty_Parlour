    ...
    <main className="about-page">
      <section className="page-hero">
        ...
        <div className="container page-hero__content">
          ...
          <h1 className="page-hero__title">About Luxéora</h1>
          <p className="page-hero__subtitle">Born from a passion for luxury beauty, redefined for the modern Indian woman.</p>
        </div>
      </section>
          ...
          <div className="about-story">
            <div className="about-story__img-col reveal-left">
              <div className="about-story__img-main">
                <img src="https://images.unsplash.com/photo-1516975080664-ed2fc6a32937?w=700&q=80" alt="Luxéora Studio" />
              </div>
            ...
            <div className="about-story__text reveal-right">
              ...
              <h2 className="section-title">A Decade of Luxury Beauty Excellence</h2>
              <p className="section-subtitle" style={{ marginTop: 'var(--space-lg)' }}>
                Luxéora Beauty Studio was born from a singular vision — to create a sanctuary where every woman feels like royalty. Founded in 2012 by Meera Kapoor, a celebrated beauty artist trained in Paris and London, Luxéora has grown from a boutique studio into Mumbai's most coveted luxury beauty destination.
              </p>
              <p style={{ fontSize: 'var(--text-base)', color: 'var(--color-text-muted)', lineHeight: 1.8, marginTop: 'var(--space-lg)' }}>
                We believe beauty is not just about appearance — it's about how you feel. Every treatment, every touch, and every transformation at Luxéora is delivered with the precision of a master artist and the warmth of genuine care. Our team of 20+ certified experts brings together decades of collective experience in luxury beauty artistry.
              </p>
              <div className="about-values">
                {[
                  ...
                  { Icon: Users,   label: 'Expert Team',       desc: '20+ certified artists with international training.' },
                ].map(({ Icon, label, desc }) => (
                  <div key={label} className="about-value">
                    <Icon size={20} style={{ color: 'var(--color-rose-gold)' }} />
                    <div>
                      <strong style={{ fontSize: 'var(--text-sm)', color: 'var(--color-brown-deep)' }}>{label}</strong>
