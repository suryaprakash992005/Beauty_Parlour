...
function buildItems(pool: (string | DomeGalleryImage)[], seg: number): GridItem[] {
...
export default function DomeGallery({
  ...
  useEffect(() => {
    ...
    const step = () => {
      ...
      const timeSinceInteraction = performance.now() - lastInteractionTimeRef.current;

      if (!isDragging && !isFocused && !isOpening && !hasInertia && timeSinceInteraction > 3000) {
